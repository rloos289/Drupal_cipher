 ...
 */
function cipher_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['cipher_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cipher_theme sample setting'),
  '#default_value' => theme_get_setting('cipher_theme_example'),
